...
Теперь у нас происходит проверка на трех версиях. При помощи прописания `strategy` и `matrix` мы избежали написания трех повторяющихся проверок для разных версий, тем самым избежав большого количества строчек пайплайна. Также можно прописать, к примеру, проверки на разных операционных версиях, добавив соответствующий параметр в `strategy`.

Ну вроде как все написано, на этом все, отчетик завершен!
